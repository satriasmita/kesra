...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if ($roleName == 'Admin Tahfidz') {
            return $this->redirect(['index-etahfidz']);
        }elseif ($roleName == 'Admin Sipanah') {
            return $this->redirect(['index-sipanah']);
        }
        return $this->render('index');
    }

    public function actionIndexEtahfidz()
    {
        return $this->render('indexetahfidz');
    }

    public function actionIndexSipanah()
    {
        return $this->render('indexsipanah');
    }
