...
<style type="text/css">
        @media print{
            @page {size: landscape; margin-top: 50px; padding-left: 0px;}
        }
</style>
        ...
        <div class="row">
            <div class="col-xs-12 text-center" style=" height: 80px;" >
                    ...
                    <td width="80%">
                        ...
                        <p style="font-size:20px; margin-top:-15px;">Nomor :  /BP4.SRTFKT/AKT-XIX/XII/2022</p>
                    </tr>
                    </table>
            </div>
        </div>
...
<h4 align="left" style="text-decoration: underline; font-weight: bold;"> </h4>
    <table style="border-spacing: 0; border-collapse: collapse; width: 100%;">
        <tr>
            <p align="center" style="width:90%; margin-right:30px; margin-left:50px; margin-top:30px; font-size: 20px;"> Badan Penasehat Pembinaan dan Pelestarian Perkawinan 
            ...
            <table style="border-spacing: 0; border-collapse: collapse; width: 100%;">
            <tr>
                <td> <p style="width:90%; margin-right:30px; margin-left:50px; font-size: 20px;"> Nama :  </p> </td>
                <td> <p style="width:90%; margin-right:30px; margin-left:50px; font-size: 20px;"> : <?= $modelPasutri['pasutri_nama']?> </p> </td>
                
            </tr>
            <tr>
                <td> <p style="width:90%; margin-right:30px; margin-left:50px; font-size: 20px;"> Tempat / Tanggal Lahir </p> </td>
                <td> <p style="width:90%; margin-right:30px; margin-left:50px; font-size: 20px;"> : <?= $modelPasutri['pasutri_ttl']?> </p> </td>
                </td>
            </tr>
            <tr>
                <td> <p style="width:90%; margin-right:30px; margin-left:50px; font-size: 20px;"> Alamat </p> </td>
                <td> <p style="width:90%; margin-right:30px; margin-left:50px; font-size: 20px;"> : <?= $modelPasutri['pasutri_alamat']?></p> </td>
                </td>
            </tr>
            </table>
        <tr >
    ...
    <table width="745" border="0" cellspacing="0" cellpadding="5" align="center">
        ...
        <td> </td>
        <td rowspan="10" align="center"> <img src="<?php echo Yii::getAlias('@web')."/images/Pasutri/".$modelPasutri->pasutri_fotoistri; ?>" alt="User Image"/></td>
        </tr>
