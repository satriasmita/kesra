                    ...
                    <div class="col-xxs-12 col-sm-12 col-md-4 wow slideInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <div class="blog-effect"> 
                            <a href="#"><figure> 
                                ...
                                <img class="img-responsive" style="width: 250px; height: 150px"src="<?php echo Url::to('@web/public/images/Badan/'. $bd->badan_image)?>" alt="">
                            ...
                            <div class="post-body"> 
                              ...
                              <h4 ><?= $bd->badan_nama ?></h4>
                                    <a style="padding: 5px;" href="<?= Url::to(['/badan/baca']) ?>?id=<?= $bd->badan_id?>" class="outline-btn">Selengkapnya <i class="fa fa-fw fa-arrow-circle-right"></i></a>
