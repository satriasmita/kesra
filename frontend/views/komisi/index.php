            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="inner-title">
                        <h2>KOMISI DPRD KOTA PARIAMAN</h2>
                        <p>Home. Blog</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xxs-12 col-sm-12 col-md-4 wow slideInLeft" data-wow-duration="1s" data-wow-delay=".5s">
                        ...
                        <div class="blog-effect"> 
                            <a href="#"><figure> 
                                ...
                                <img class="img-responsive" style="width: 250px; height: 150px"src="<?php echo Url::to('@web/public/images/Komisi/'. $kom->komisi_image)?>" alt="">
                            ...
                            <div class="post-body"> 
                              <div class="post-info">
                                ...
                                <a href="#"><span class="icon icon-Pen"><?= $kom->komisi_jabatan ?></span> 
                                <h4 ></h4>

                                <!-- ?= $news->berita_tanggal; ?></a>  -->
                                <!-- ?= $row->authorCreate->username; ?></a>  -->
                              </div>
                              <h4 ><?= $kom->komisi_nama ?></h4>

                                    <a style="padding: 5px;" href="<?= Url::to(['/komisi/baca']) ?>?id=<?= $kom->komisi_id?>" class="outline-btn">Selengkapnya <i class="fa fa-fw fa-arrow-circle-right"></i></a>
