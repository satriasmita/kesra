                       ...
                       <div class="col-md-4">
                            <div class="sidebar">
                                ...
                                <div class="sidebar-widget popular-posts">
                                    <div class="sidebar-title"><h2>Daftar <span class="text-theme-color">Pengumuman</span></h2></div>
                                    <?php 
                                        $pengumumanopd = (new Posting)->getFrontendPengumuman(); 
                                        foreach ($pengumumanopd as $row) {
                                    ?>
                                        <article class="post">
